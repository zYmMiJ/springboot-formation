...
import nc.opt.config.audit.AuditEventConverter;
import nc.opt.domain.PersistentAuditEvent;
...
import static nc.opt.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
